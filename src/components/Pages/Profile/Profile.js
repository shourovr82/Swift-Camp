...
const Profile = () => {
  ...
  return (
    <div className='flex justify-center my-28'>
      <div className="flex flex-col justify-center max-w-xs p-16 
      shadow-md rounded-xl sm:px-12 bg-gray-900 text-gray-100">

        <img src={user?.photoURL ? user.photoURL : 'https://i.ibb.co/BZt8Ky7/depositphotos-43381243-stock-illustration-male-avatar-profile-picture.webp'} alt="" className="w-32 h-32 mx-auto rounded-full bg-gray-500 aspect-square" />
        <div className="space-y-4 text-center divide-y divide-gray-700">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">{user.displayName ? user.displayName : 'No name given'}</h2>
            <p className="px-5 text-xs sm:text-base text-gray-400">Email : {user.email ? user.email : 'no email found'}</p>
            <p className="px-5 text-xs sm:text-base text-gray-400">Junior front end developer</p>
          </div>
